...
export default function App() {
  ...
  return (
    <main className="shell">
      ...
      <p className="notice">
        This learning prototype is not production authentication and must not contain real patient data.
      </p>
      ...
      <section className="card">
        ...
        <div className="table-wrap">
          <table>
            <thead>
              <tr>
                <th>Time</th><th>Patient</th><th>Clinician</th><th>Reason</th><th>Status</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
      ...
      {role === 'Receptionist' ? (
        ...
        <section className="card"><p>Clinicians can update clinical statuses but cannot create patients, book, reschedule, or cancel appointments.</p></section>
      )}
